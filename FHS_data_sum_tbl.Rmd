...
# seeing the proportion of complete cases
sum(complete.cases(fhs_most_recent))/nrow(fhs_most_recent) # 50% missingness
```
...
sum(complete.cases(fhs_most_recent_red))/nrow(fhs_most_recent_red) # 96% complete
